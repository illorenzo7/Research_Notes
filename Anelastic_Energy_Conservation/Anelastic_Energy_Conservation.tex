...
\end{align}
 ...
 The internal heating (or cooling) terms $\qref + Q_1$ are assumed ``accounted for," since they represent known physical processes like nuclear burning, Kelvin-Helmholtz contraction, or radiative cooling. Thus, Equation \eqref{eq:antote} shows that the total energy integrated over the volume $V$ of the layer,
\begin{align}
