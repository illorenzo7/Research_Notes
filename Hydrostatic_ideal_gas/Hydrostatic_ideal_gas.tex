...
\label{eq:rhogeneral}
	...
	\tmpref(r) &= \tmpref_0\left[\tilde{a}\parenfrac{r_0}{r} + (1-\tilde{a})\right]  \ \ \ \ \ \text{(adiabatic atmosphere)},\label{eq:tad}\\
