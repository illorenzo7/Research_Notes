...
Figure \ref{fig:coords} shows schematically how this works. We set up a local Cartesian coordinate system (with origin at the point $(r,\theta,\phi)$) denoted by $(x_1,x_2,x_3)$. As we differentiate $\vecu$, the spherical-coordinate unit vectors change, while the Cartesian ones stay fixed. In particular, if we move from $(r,\theta,\phi)\rightarrow (r+\delta r, \theta + \delta\theta, \phi + \delta\phi)$ (or in the Cartesian system, $(0, 0, 0)\rightarrow (\delta x_1, \delta x_2, \delta x_3)$)  
  \begin{figure}
