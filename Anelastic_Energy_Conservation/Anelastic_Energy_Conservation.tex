...
By contrast, for the anelastic motion, Equation \eqref{eq:eggen} (with $Q^\prime\equiv0$, $\vecf^\prime\equiv0$, and $\mutilde\equiv0$) yields
 \begin{align}\label{snotconst}
 	\frac{d\gptot}{dt}= \int_V\entrtilde \pderiv{\rhoover}{t}dV + \int_V \frac{\heatnlbr}{\tmptilde}dV, 
 \end{align}
 which $\neq0$ under any circumstances because $\pderivline{\rhoover}{t}\neq0$. there are no circumstances in which the anelastic motion conserves total entropy. 
 Equation \eqref{eq:eggen} becomes
