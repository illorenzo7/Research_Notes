...
\begin{alignat}{2}
	...
	\\
	  &-\left[ \frac{1}{r} \left(  \pderiv{\ut}{\theta} + \cott\ut  \right)    +    \orsint \pderiv{\up}{\phi}    +    \frac{2\ur}{r}  \right] \br   && \five \text{$r$: transverse compression}
\end{alignat}
\end{subequations}
...
\begin{subequations}
	\begin{alignat}{2}
		I_r = \  &  r \left(   \br\pderiv{}{r}    +    \frac{\bp}{\rsint}\pderiv{}{\phi}   \right)  \left(  \frac{\ut}{r}  \right) &&  \five \text{transverse shear}
		\\
		&-\ \ugrad\bt && \five\text{advection}
		\\
		&-\bigg{[}  \frac{1}{r} \left(  \pderiv{\ut}{\theta} + \cott\ut  \right)    +    \orsint \pderiv{\up}{\phi}    +    \frac{2\ur}{r}  \bigg{]} \br   && \five \text{transverse compression}
	\end{alignat}
\end{subequations}
