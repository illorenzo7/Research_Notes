...
\end{align}
and the $\Delta S$ (which appears in the Rayleigh number) is the already-chosen entropy scale. For consistency, we should non-dimensionalize the entropy gradient like
\begin{align}
