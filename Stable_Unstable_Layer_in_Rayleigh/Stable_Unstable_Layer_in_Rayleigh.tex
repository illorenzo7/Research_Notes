...
\section{Nondimensional equations, functions, and constants for $\tau=\tauomega$}
...
\begin{subequations}\label{eq:momndrot}
	\begin{align}
		\rhotilde\left(\matderiv{\vecu} + \ez\times\vecu\right) = &\ \roc^2 \rhotilde\gtilde S\er         -\rhotilde\nabla\left[ \frac{P}{\rhotilde} \right], \nonumber\\
