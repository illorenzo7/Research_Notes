...
\end{align}
  ...
  In each of Equations \eqref{eq:anmeanmom} and \eqref{eq:anmeanen}, each term on the right-hand side is $O(\epsilon)$ compared to each term on the left-hand side. In particular, we can approximate 
...
Dotting $\vecu$ into Equation \eqref{eq:anmommain} and using Equation \eqref{eq:anmeanmom} yields the anelastic kinetic energy equation,
 ...
 Note that from Equation \eqref{eq:lintp}, the left-hand side of Equation \eqref{eq:anen} can be written in terms of the entropy $\entrone$, 
