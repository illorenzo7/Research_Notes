...
Putting it all together (and using the ideal gas law to derive the density), we have
	\begin{empheq}[box=\fbox]{align}
\tmpref\ofr &= \tmpref_0\left[\frac{b}{n+1}\left(\frac{r_0}{r}\right) + \frac{n+1-b}{n+1}\right] \ \ \ \ \ \text{(polytropic atmosphere)}.\label{eq:tmppolytrope1} \\
\prsref\ofr &= \prsref_0\left[\frac{b}{n+1}\left(\frac{r_0}{r}\right) + \frac{n+1-b}{n+1}\right]^{n+1} \ \ \ \ \ \text{(polytropic atmosphere)}. \label{eq:prspolytrope1}\\
\rhoref\ofr &= \rhoref_0\left[\frac{b}{n+1}\left(\frac{r_0}{r}\right) + \frac{n+1-b}{n+1}\right]^n \ \ \ \ \ \text{(polytropic atmosphere)}. 
...
\andd \frac{\sref\ofr}{\cp} &= \left(\frac{n-\tilde{n}}{\tilde{n}+1}\right)\left\{\ln{\left(\frac{r}{r_0}\right)} - \ln{\left[\frac{b}{n+1}+\frac{n+1-b}{n+1}\left(\frac{r}{r_0}\right)\right]}\right\}\label{eq:spolytrope}\\
...
\prsref\ofr&\rightarrow \prsref_0\exp{\left[\frac{G\mstar}{\gasconst \tmpref_0r_0}\left(\frac{r_0}{r}-1\right)\right]},\\
\rhoref\ofr&\rightarrow \rhoref_0\exp{\left[\frac{G\mstar}{\gasconst \tmpref_0r_0}\left(\frac{r_0}{r}-1\right)\right]},\\
\frac{1}{\cp}\dsdr &\rightarrow \frac{G\mstar}{\cp\tmpref_0r^2},\\
 \andd \frac{\sref\ofr}{\cp} &\rightarrow \frac{G\mstar}{\cp\tmpref_0r_0}\left(1-\frac{r_0}{r}\right)\\ 
...
\begin{align}
\boxed{
\sref\ofr = k\cp\left(\frac{r}{\rrm} - 1\right)\five \andd \dsdr = \frac{k\cp}{\rrm}\five \text{(constant entropy gradient)},
}
\end{align}
...
\begin{empheq}[box=\fbox]{align}
\tmpref\ofr &= T_{\rm{m}}\left\{\left[e^k\tilde{a}\left(\frac{\rrm}{r}\right) E_2\left(\frac{kr}{\rrm}\right) + (1-e^kE_2(k)\tilde{a})\right]\ekp\right\},\\
...
Using \eqref{eq:pgeneral} and \eqref{eq:rhogeneral} then yields
	\begin{empheq}[box=\fbox]{align}
\prsref\ofr =\ &p_{\rm{m}}\exp{\left[-\frac{\gamma}{\gamma-1}k\left(\frac{r}{\rrm} - 1\right)\right]}\nonumber\\
	&\times\left\{\left[e^k\tilde{a}\left(\frac{\rrm}{r}\right) E_2\left(\frac{kr}{\rm}\right) + (1-e^kE_2(k)\tilde{a})\right]\ekp\right\}^{\gamma/(\gamma-1)}\\
\andd \rhoref\ofr =\ &\rho_{\rm{m}}\exp{\left[-\frac{\gamma}{\gamma-1}k\left(\frac{r}{\rm}\right)\right]}\nonumber\\
&\times
\left\{\left[e^k\tilde{a}\left(\frac{\rrm}{r}\right) E_2\left(\frac{kr}{\rrm}\right) + (1-e^kE_2(k)\tilde{a})\right]\ekp\right\}^{1/(\gamma-1)}\\
\five &\text{(constant entropy gradient).}\nonumber
\end{empheq}
