...
\begin{empheq}[box=\fbox]{align}
\tmpref\ofr &= T_{\rm{m}}\bigg{\{}\left[e^k\tilde{a}\left(\frac{\rrm}{r}\right) E_2\left(\frac{kr}{\rrm}\right) + (1-e^kE_2(k)\tilde{a})\right]\ekp\bigg{\}},\\
...
\prsref\ofr =\ &p_{\rm{m}}\exp{\left[-\frac{\gamma}{\gamma-1}k\left(\frac{r}{\rrm} - 1\right)\right]}\nonumber\\
	&\times\bigg{\{}\left[e^k\tilde{a}\left(\frac{\rrm}{r}\right) E_2\left(\frac{kr}{\rm}\right) + (1-e^kE_2(k)\tilde{a})\right]\ekp\bigg{\}}^{\gamma/(\gamma-1)}\\
\andd \rhoref\ofr =\ &\rho_{\rm{m}}\exp{\left[-\frac{\gamma}{\gamma-1}k\left(\frac{r}{\rm}\right)\right]}\nonumber\\
&\times
\bigg{\{}\left[e^k\tilde{a}\left(\frac{\rrm}{r}\right) E_2\left(\frac{kr}{\rrm}\right) + (1-e^kE_2(k)\tilde{a})\right]\ekp\bigg{\}}^{1/(\gamma-1)}\\
\five &\text{(constant entropy gradient).}\nonumber
\end{empheq}
