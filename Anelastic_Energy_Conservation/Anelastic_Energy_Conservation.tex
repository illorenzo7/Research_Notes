...
\newcommand{\wheat}{W^\prime_{\rm heat}}
\newcommand{\wcomp}{W^\prime_{\rm compression}}
\newcommand{\wpot}{W^\prime_{\rm potential}}
\newcommand{\welast}{W^\prime_{\rm elastic}}
% date, author, title
\date{\today}
...
\begin{align}\label{eq:perten1}
	...
	&= \underbrace{\rhotilde\tilde{T} \entrprime}_{\define \wheat} + \underbrace{\left(\tilde{U}+\frac{\tilde{P}}{\rhotilde}+\Phi\right)\rhoprime}_{\define\wcomp}.
\end{align}
...
\begin{subequations}\label{eq:perten2}
	\begin{align}
		W^\prime &= \wheat + \wcomp,\\
		\where \wheat&\define \rhotilde\tmptilde \entrprime\\
