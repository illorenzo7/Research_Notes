...
The final constant $\rhotilde(\rbcz)$ ends up not having an analytical expression but can be easily found by integration over the CZ of Equation \eqref{eq:rhotilde}.  
